                ...
                >
                    <div class="d-flex flex-wrap justify-center justify-sm-start flex-grow-1 gap-3">
                        <span class="d-flex align-center mr-5">
                            <VIcon size="24" icon="mdi-invert-colors" class="me-2" color="warning"/>
                        ...
                        <span class="d-flex align-center mr-5">
                            <VIcon size="24" icon="mdi-map-marker-outline" class="me-2" color="success"/>
                            <span class="text-body-1 font-weight-medium">
                                {{ building.address }}
                            </span>
                        </span>
                        ...
                        <span class="d-flex align-center">
                            <VIcon size="24" icon="mdi-calendar-blank" class="me-2" color="info"/>
                            <span class="text-body-1 font-weight-medium">
                                {{ building.createTime }}
                            </span>
                        </span>
